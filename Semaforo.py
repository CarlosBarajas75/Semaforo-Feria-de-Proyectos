...
COLORS = {
    'bg_primary': '#293251',      # Azul oscuro para el fondo principal
...
def abrir_ventana_visual():
    ...
    try:
        ...
        identidad_label.pack(anchor='center', pady=(0, 10))
    except Exception:
        pass
    ...
    evento_label.pack(anchor='w', pady=(0, 2), fill='x')
    ...
    equipo_label = tk.Label(frame_textos, 
                           ...
                           fg=COLORS['text_primary'],
                           anchor='w', justify='left', wraplength=240)
    equipo_label.pack(anchor='w', pady=(0, 2), fill='x')
    ...
    tema_equipo_label = tk.Label(frame_textos,
                                 ...
                                 fg=COLORS['text_primary'],
                                 anchor='w', justify='left', wraplength=240)
    tema_equipo_label.pack(anchor='w', pady=(0, 2), fill='x')
    ...
    etapa_label = tk.Label(frame_textos,
                          ...
                          anchor='w', justify='left', wraplength=240)
    etapa_label.pack(anchor='w', pady=(0, 2), fill='x')
